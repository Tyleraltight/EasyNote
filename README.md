...
**EasyNote** 是一款极简主义风格的个人效率管理应用，结合了**年度目标（Flag）追踪**、**随手记/待办事项**以及**日历进度回顾**功能。支持 GitHub / Google 登录 + Supabase 云端同步，在手机和电脑上随时查看同一份数据。
...
- 🎯 **Flag 目标追踪系统**
  ...
  - **🌐 多语言支持**：支持简体中文与英文自由一键切换，智能识别浏览器系统语言。
...
- 📝 **极简边栏：想法与待办**
  ...
  - **悬浮操作**：待办事项支持悬浮删除与置顶交互（移动端始终可见）。

- 🔐 **GitHub & Google 登录 + 云端同步**
  - **一键登录**：通过 GitHub 或 Google OAuth 授权登录。
  - **跨设备同步**：手机和电脑登录同一个账号，数据实时自动同步。
...
6. 启动开发服务器：
   ...
   npm run dev
   ```
7. 打开浏览器访问 `http://127.0.0.1:5173` 即可开始使用。
